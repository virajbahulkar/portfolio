...
<div class=" shadow-xl rounded-2xl p-6 mb-8 ">
  ...
  <ul class="list-disc list-inside my-4 space-y-2">
    <li>Gave users a configurable interface for real-time reporting and historical analysis.</li>
    <li>Reduced the need for hard-coded dashboards by supporting reusable visualization workflows.</li>
  </ul>
</div>
