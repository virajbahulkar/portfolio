...
<div class=" shadow-xl rounded-2xl p-6 mb-8 ">
  ...
  <ul class="list-disc list-inside my-4 pt-1">
    <li><strong>10,000+ developers</strong> using the platform.</li>
    <li><strong>500K+ monthly downloads</strong> across the open-source distribution.</li>
    <li><strong>35% performance improvement</strong> in builder responsiveness.</li>
    <li><strong>60% reduction in backend query latency</strong> on key execution paths.</li>
  </ul>
...
Pull request → review + tests → merge → release path for self-hosted upgrades</code></pre>
  ...
  <ul class="list-disc list-inside my-4 pt-1">
    <li>Optimized builder rendering and interaction flows for faster configuration of complex internal tools.</li>
    <li>Improved backend query paths and payload handling to reduce latency.</li>
    <li>Expanded test coverage on builder and execution flows to improve delivery confidence.</li>
  </ul>

  <hr class=" mb-8 mt-8 border border-base-300">

  <h2 class="text-2xl font-semibold mb-4">Reliability & delivery</h2>
  <ul class="list-disc list-inside my-4 pt-1">
  ...
  <ul class="list-disc list-inside my-4 pt-1">
    <li>Improved builder performance by <strong>35%</strong>.</li>
    <li>Reduced backend query latency by <strong>60%</strong>.</li>
    <li>Increased delivery confidence with broader automated test coverage.</li>
  </ul>
</div>
