  ...
  >
    ...
    {link && (
      <div className="lg:w-auto">
        <a
          href={link}
          className="block max-w-xs break-words rounded-full bg-primary px-4 py-2 text-center text-sm text-white shadow-lg transition-transform duration-300 hover:bg-secondary lg:max-w-none"
        >
          {linkText} →
        </a>
      </div>
